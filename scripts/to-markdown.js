import he from "he";
export const toMarkdown = function (string) {
  var ELEMENTS = [
    {
      patterns: [
        /<pre[^>]*><code[^>]*class="language-([^>]*)"[^>]*>([^<]*)<\/code><\/pre>/gi,
      ],
      replacement: function (str, lang, innerHTML) {
        return `\n\`\`\`${lang}\n${he.decode(innerHTML)}\`\`\``;
      },
    },
    {
    ...
    { patterns: "br", type: "void", replacement: "\n" },
    {
      ...
      replacement: function (str, hLevel, attrs, innerHTML) {
        ...
        return "\n\n" + he.decode(hPrefix) + " " + he.decode(innerHTML) + "\n";
      },
    },
  ...
  function replaceEls(html, elProperties) {
    let regex;
    if (elProperties.tag instanceof RegExp) {
      regex = elProperties.tag;
    } else {
      var pattern =
